...
\033[35m                ╔═══════════════════════════════════════════════╗
\033[35m                ║\033[32m- - - - - - - Exp By \033[36m@Wizzly \033[35m- - - - - - -║
...
def main():
	...
	while True:
		...
		sys.stdout.write("\x1b]2;ItsMeWizzly. | Devices: [{}] | Spoofed Servers [19] | Server Units [8] | Clients: [18]\x07".format (bots))
		sin = input("\033[32m[\033[35m{}\033[32m@EXP]\033[36m$ \033[96m".format(nicknm)).lower()
		sinput = sin.split(" ")[0]
		if sinput == "clear":
			os.system ("clear")
			print (banner)
		  ...
		  main()
			...
			try:
				if running >= 1:
					...
					print("\033[97mWizzly Attack Has Been Started ")
			except ValueError:
				main()
